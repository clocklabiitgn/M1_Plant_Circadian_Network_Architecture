...
filename = 'summer_solstice.xlsx'  # Excel file name
...
ProteinLevel = []
C = 1*np.ones((1,19)) #initial conditions for all 20 variables
C[0,11] = 0
C[0,15] = 0
C[0,16] = 0
C[0,17] = 0
...
filename = 'normalized_summer_solstice_exp.xlsx'  # Excel file name
sheet = 0  # Sheet index (0-based for pandas)
# Read the Excel file into a DataFrame
data = pd.read_excel(filename, sheet_name=sheet)
