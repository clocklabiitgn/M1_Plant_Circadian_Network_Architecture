...
filename = 'autumn_equinox.xlsx'  # Excel file name
...
# Extract values from index 199 to 247 TO ACCOUNT FOR LAST 48 HOURS
...
filename = 'normalized_autumn_equinox_exp.xlsx'  # Excel file name
sheet = 0  # Sheet index (0-based for pandas)
# Read the Excel file into a DataFrame
data = pd.read_excel(filename, sheet_name=sheet)
